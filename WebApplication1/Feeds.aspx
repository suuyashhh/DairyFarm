<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feeds.aspx.cs" Inherits="WebApplication1.Feedss" %>
...
<body>
            ...
            <div class="content">
                <div class="row justify-content-center align-items-center w-100">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <div class="form-group">
                            <label for="feedDropdown" class="form-label">Feed Name*</label>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="feedqty" CssClass="form-control form-control-lg" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="feedPrice" class="form-label">Price*</label>
                            <asp:TextBox ID="feedPrice" CssClass="form-control form-control-lg" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnSubmitFeed" OnClick="btnSubmitFeed_Click" OnClientClick="return valid()" Text="Submit" CssClass="btn-submit" runat="server" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function valid() {
            ...
            var feedname = document.getElementById('<%= this.ddlfeedname.ClientID %>').value;
            var qty = document.getElementById('<%= this.feedqty.ClientID %>').value;
            var price = document.getElementById('<%= this.feedPrice.ClientID %>').value;
